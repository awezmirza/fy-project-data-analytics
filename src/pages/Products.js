...
import useProductCSVValidation from '../hooks/useProductCSVValidation';
import useCSVUpload from '../hooks/useCSVUpload';
import ProductsChart from '../components/ProductsChart';

const Products = () => {
    const { isValid: isProductCSVValid, validateProductCSV } = useProductCSVValidation();
    const { data: productData, handleCSVUpload: handleProductUpload } = useCSVUpload(validateProductCSV);
    ...
    return (
        <div className='product-page'>
            ...
            {isProductCSVValid && productData.length > 0 && (
                <ProductsChart
